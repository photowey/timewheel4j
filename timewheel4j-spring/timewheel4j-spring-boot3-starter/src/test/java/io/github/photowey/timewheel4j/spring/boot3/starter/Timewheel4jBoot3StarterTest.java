 ...
 */
package io.github.photowey.timewheel4j.spring.boot3.starter;
...
/**
 * Timewheel4jBoot3StarterTest.
 *
 * @author photowey
 * @version 1.0.0
 * @since 2026/06/26
 */
class Timewheel4jBoot3StarterTest {
    ...
    @Test
    void givenBoot3StarterWhenAutoConfigurationIsLoadedThenItUsesAutoConfigurationAnnotation() {
        assertThat(this.autoConfigurationClass.getAnnotation(AutoConfiguration.class)).isNotNull();
    }

    @Test
    void givenBoot3StarterWhenMetadataIsReadThenStarterOwnsAutoConfigurationEntry() throws IOException {
    ...
    @Test
    void givenBoot3RuntimeWhenContextRunsThenTimerBeanIsCreated() {
        this.contextRunner
    ...
    private static String resource(String name) throws IOException {
        try (InputStream input = Timewheel4jBoot3StarterTest.class.getClassLoader().getResourceAsStream(name)) {
